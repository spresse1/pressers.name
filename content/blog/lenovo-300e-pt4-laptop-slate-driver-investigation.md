...
You can drop everything before the bar (`|`) in order to be able to make the choices yourself -- I just don't think that's likely to be useful here.
...
We can check that this worked by seeing that the kernel module is in `this file`
